...
| 8 | Polish | In progress | 2026-04-01 | logging_setup.py, autostart.py, test_autostart.py created; recorder/transcriber/app/settings_dialog updated; CUDA OOM fallback; first-run UX; hotkey toggle mode added for quick-tap lock/unlock recording; full suite passes 35/35 | Commit changes |
